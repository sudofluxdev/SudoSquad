...
`localStorage`, `sessionStorage`, and `document.cookie` are synchronous and expensive. Cache reads in blackbox.
...
- It avoids consuming blackbox for the joined strings (especially important for large arrays)
